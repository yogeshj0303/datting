              ...
              <div class="page-breadcrumb bg-white">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-9 col-md-4 col-sm-4 col-xs-12 pull-left">
                        ...
                        <h4 class="page-title">Add Ticket Issue</h4>
                    ...
                    <div class="col-lg-3 col-sm-8 col-md-8 col-xs-12 pull-right">
                        ...
                        <div class="d-md-flex ">
                           ...
                           <li><a href="#" class="fw-normal">Dashboard</a></li>
                            ...
                            <a class="btn btn-success" style="text-align:right; width:75px; margin-left: 133px;" href="{{ route('ticketissue.create') }}">Add</a>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $temp->department_name }}</td>
                     
                      <td>
                       
    
                        <a href="{{ route('ticketissue.edit', $temp->id) }}"

                            title="Edit"><i class="fa fa-edit text-success"></i></a> 
                           

                        &nbsp;
                        <form action="{{ route('ticketissue.destroy', $temp->id) }}"
